<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Add_Student.aspx.cs" Inherits="Teacher_Add_Student" %>
            ...
            <ContentTemplate>
                <div id="body">
                    ...
                    <div class="status bottom">
                        ...
                        <asp:Label ID="status" runat="server" Text="Admin Panel / Add New Student"></asp:Label>
                    </div>
                    <div id="content">
                        ...
                        <div class="input-box">
                            ...
                            <div class="btnContainer">
                                ...
                                <asp:Button ID="btnRegister" Text="Register" class="fas fa-user-plus" 
                                    CssClass="btn" runat="server" OnClientClick="Confirm to register!" onclick="btnRegister_Click"   />
