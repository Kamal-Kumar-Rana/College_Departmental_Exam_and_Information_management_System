<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Assignment_Submit.aspx.cs" Inherits="Student_Assignment" %>
        ...
        <!--<asp:UpdatePanel ID="updatePage" runat="server">
            <ContentTemplate>-->
                <div id="body">
                     ...
                     <h1>Assignment Submit Page</h1>
        <label for="name">Assignment Id:</label>
      <asp:TextBox ID="txtId" runat="server"></asp:TextBox>
       <br><br>
         <label for="name">Paper Code:</label>
