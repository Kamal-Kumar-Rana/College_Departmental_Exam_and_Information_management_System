...
<head id="Head1" runat="server">
    ...
    <link href="../Teacher/CSS/Dashboard_image.css" rel="stylesheet" type="text/css" />
    <%
                ...
                <div id="body">
                    ...
                    <div id="content">
                        ...
                        <asp:Panel ID="task" class="window" runat="server" Visible="false">
                            <p></p>
                            <div class="lbl">
                                <asp:Label ID="lblDailyTask" runat="server" Text=""></asp:Label>
                            </div>
                        </asp:Panel>
                        <div id="info" class="window">
                            ...
                            <div class="tab">
                                <p>Previous Exam Marks </p>
                                <div class="content">
                                    
                                    <asp:Label ID="lblBoost" runat="server" Text=""></asp:Label>
                                </div>
                            </div>
                            <div class="tab">
                                <p>Ongoing Exam</p>
