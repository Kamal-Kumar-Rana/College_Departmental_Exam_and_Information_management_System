...
<body>
    <form id="dashboard" runat="server">
        ...
        <%
            string headerpath = HttpContext.Current.Server.MapPath("Html/Publish_Notice.htm");
            ...
            <ContentTemplate>
                <div id="body">
                    ...
                    <div class="status bottom">
                        ...
                        <asp:Label ID="status" runat="server" Text="Admin Panel / Publish Notice"></asp:Label>
                    </div>
                    <div id="content">
